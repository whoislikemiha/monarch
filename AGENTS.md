...
- **Quest refs are references, not authority** (roadmap P5) — `quest_refs` links quests to Linear/GitHub/files/URLs/artifacts. The quest remains canonical; external trackers are context and evidence.
