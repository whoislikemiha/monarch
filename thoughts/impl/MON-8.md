...
- **Shadow-oath / CLAUDE.md token footprint optimisation** — came up during verification ("hi" = ~1k tokens on turn 1). Acknowledged as a real lever for small-window LM Studio models, but a separate concern from the meter bug. Marko will open a follow-up issue.
